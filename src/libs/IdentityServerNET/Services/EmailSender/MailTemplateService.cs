...
public class MailTemplateService : IMailTemplateService
{
    ...
    public MailTemplateService(IConfiguration configuration)
    {
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#eef6ff;padding:48px 16px;">
                <tr><td align="center">
                  <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
                    <tr>
                      <td style="background:linear-gradient(135deg,#0094ff 0%,#0070cc 100%);border-radius:12px 12px 0 0;padding:36px 48px;text-align:center;">
                    ...
                    <tr>
                      <td style="background:#fff;padding:48px;border-radius:0 0 12px 12px;box-shadow:0 4px 24px rgba(0,148,255,.12);">
                        ...
                        <table cellpadding="0" cellspacing="0" style="margin:0 auto 32px auto;">
                          <tr>
                            <td style="background:linear-gradient(135deg,#0094ff 0%,#0070cc 100%);border-radius:8px;box-shadow:0 4px 12px rgba(0,148,255,.35);">
                        ...
                        <p style="color:#0094ff;font-size:12px;word-break:break-all;text-align:center;margin:0 0 32px 0;">{{link}}</p>
                  ...
                  <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
                    ...
                    <tr>
                      <td style="background:#fff;padding:48px;border-radius:0 0 12px 12px;box-shadow:0 4px 24px rgba(0,148,255,.12);">
                        ...
                        <p style="color:#0094ff;font-size:12px;word-break:break-all;text-align:center;margin:0;">{{link}}</p>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:24px;text-align:center;">
